...
while 1:
  ...
  if (MY_DXL == 'XL320'): # XL320 uses 2 byte Position Data, Check the size of data in your DYNAMIXEL's control table
      ...
      dxl_present_position2, dxl_comm_result, dxl_error = packetHandler.read4ByteTxRx(portHandler, DXL_ID+1, ADDR_PRESENT_POSITION)
      dxl_present_position3, dxl_comm_result, dxl_error = packetHandler.read4ByteTxRx(portHandler, DXL_ID+2, ADDR_PRESENT_POSITION)
